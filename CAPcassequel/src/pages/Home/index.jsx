...
export function Home() {
  ...
  return (
    ...
    <Container >
      ...
      <div className="container mt-5 fundo1" data-aos="fade-up">
        <h3 class=" fs-4 text-center" >Olá, Seja bem-vindo!</h3>

        <img src="images/church.png" className="float-md-start" width={400} />
        <div className="mt-5">
      ...
      <div className="container mt-3 mt-md-0" data-aos="fade-right">
      ...
      <div className="container-fluid row py-4">
        ...
        <div className="col-12 col-sm-6 col-md-6 col-md-4 col-lg-3" data-aos="fade-left">
        ...
        <div className="col-12 col-sm-6 col-md-6 col-md-4 col-lg-3" data-aos="fade-right">
        ...
        <div className="col-12 col-sm-6 col-md-6 col-md-4 col-lg-3" data-aos="fade-up">
      ...
      <div className="container row py-3" >
        ...
        <div className="col-sm-6" >
          <img src="images/mapa.png" className="img rounded   d-block " width={400} alt="" />
        </div>
      </div>
